...
public class Destination_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateTravelLogsList();     //The list of travel logs
        updateTotalVacationDays();  //New method call to upload total vacation days displayed
    ...
    //calculate the duration of vacation in days with start and end dates.
