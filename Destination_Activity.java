...
public class DestinationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        formLayout.setVisibility(View.GONE);  // Hide form by default
        ...
        calculateVacationButton.setOnClickListener(v -> {
            ...
            // Update the travel logs list and hide the form
        ...
        setupDashboardButtons();  // Initialize dashboard navigation buttons
    }
